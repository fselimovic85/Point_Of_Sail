...
{
    public partial class POSLOVNI_PARTNERI : Form
    {
        ...
        public void Ucitaj_Poslovnog_Partnera()
        {
            ...
            cn.Open();
            cm = new SqlCommand("Select * from POSLOVNI_PARTNER order by id", cn);
            dr = cm.ExecuteReader();
            while (dr.Read())
            {
                i += 1;
        ...
        public void Unesi_Novog_PP_a()
        {
            try
            {
                ...
                cm = new SqlCommand(" SELECT * " +
                                    ...
                                    " WHERE  PIB='" + textPIB_PP_a.Text + "'", cn);
                ...
                while (dr.Read())
                {
                    ...
                    {
                        MessageBox.Show(" Postoji već PP sa datim PIB-om, proverite upis ", " Upozorenje !!!",
                ...
                if (textPIB_PP_a.Text != "")
                {
                    ...
                    cn.Open();
                    cm = new SqlCommand(" INSERT INTO POSLOVNI_PARTNER ( naziv_pp, PIB, maticni_broj, adresa, vrsta_pp, detalji_pp ) " +
        ...
        public void Pretraga_PP_a()
        {
            ...
            dataGrid_PP_a.Rows.Clear();
            cn.Open();
            cm = new SqlCommand("Select * from POSLOVNI_PARTNER " +
        ...
        public void Izmeni_PP_a()
        {
            if (MessageBox.Show("Želite li zaista za izmenite podatke o PP-u", "Podaci o PP-u", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                while (dr.Read())
                {
                    if (textPIB_PP_a.Text == dr["PIB"].ToString())
                    {
                        MessageBox.Show("Postoji radnik sa datim PIB, unesite novi PIB",
                ...
                if (textPIB_PP_a.Text != "")
                {
                    ...
                    cm = new SqlCommand(" UPDATE POSLOVNI_PARTNER set naziv_pp=@naziv_pp, " +
                                                            " PIB=@PIB," +
        ...
        private void btnUcitaj_PP_a_Click(object sender, EventArgs e)
        {
            Ucitaj_Poslovnog_Partnera();
        }

        private void btnNovi_PP_a_Click(object sender, EventArgs e)
        {
            Unesi_Novog_PP_a();
        }

        private void btnPretraga_PP_a_Click(object sender, EventArgs e)
        {
            Pretraga_PP_a();
        }
        ...
        private void dataGrid_PP_a_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (ime_kolone_pp_a == "Delete_PP_a")
            {
                try
                {
                    ...
                    {
                        cn.Open();
                        cm = new SqlCommand(" DELETE FROM POSLOVNI_PARTNER " +
